...
import com.utad.api_peliculas.adapters.PeliculasAdapter
...
class VistaPeliculas : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = PeliculasAdapter(data) {
            val fragment = VistaDetallePelicula()
            val bundle = Bundle()
            bundle.putSerializable("peli",it)
        ...
        toolbar.title = "Cine de " + genero.name
